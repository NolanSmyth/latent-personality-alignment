...
| [EXP-018](EXP-018.md) | 2026-02-25 | Eval Methodology Gap: Generation Collapse | LPA safety gains are generation collapse artifacts — internal knowledge intact (lm-eval MMLU preserved) but generation mode collapsed (eval.py MMLU→0, ASR→0). Not genuine personality internalization. |
